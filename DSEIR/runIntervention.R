...
beta= 0.33 #Transmission rate (mild infections)
...
Tint1 = 50 #Intervention start time (days)
Tint2 = 100 #Intervention end time (days)
s1=30 #Reduction in transmission from mild infections
s2=50 #Reduction in transmission from severe infections
...
input=list("IncubPeriod"=IncubPeriod,"DurMildInf"=DurMildInf,"FracSevere"=FracSevere,"FracCritical"=FracCritical,"ProbDeath"=ProbDeath,"DurHosp"=DurHosp,"TimeICUDeath"=TimeICUDeath,"beta"=beta,"delta"=delta,"b31"=b31,"rho"=rho,"LogN"=LogN,"Tmax"=Tmax,"InitInf"=InitInf,"yscale"=yscale,"VarShowInt"=VarShowInt,"Tint1"=Tint1,"Tint2"=Tint2,"s1"=s1,"s2"=s2,"s3"=s3,"RoundOne"=RoundOne)
