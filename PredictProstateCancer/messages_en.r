...
warning_psa_en = HTML("We are sorry, but we can not calculate the risk of prostate cancer. <br />
                      PSA has to be between 0.1 and 50 [ng/ml].")

warning_prompt_en = HTML("We are sorry, but we can not calculate the risk of prostate cancer. <br />
                      Prompt has to be between 0.1 and 10.")
...
warning_overall_en = HTML("We are sorry, but we can not calculate the risk of prostate cancer. Age, PSA and Prompt are mandatory.")
...
tooltip_psa_en = "This is the result, in nanograms per mililiter, of the PSA blood test. PSA has to be between 0.1 and 50 [ng/ml]."

tooltip_prompt_en = "Prompt needs to be between 0.1 and 10."
