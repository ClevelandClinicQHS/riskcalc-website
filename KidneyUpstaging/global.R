...
calcSmiley = function(risk){
    ...
    res0_en = "Based on the provided risk factors a surgery performed would have a:"

    res1_en = "<br>
    <table height=80% width=90%>
    <tbody><tr>
    <td ><img src='man_red.png' width='23 height='47' alt='red face'></td><td>"
    ...
    res2_en = "% chance of kidney cancer upstaging,</td>
    </tr><tr>
    <td class='center'><img src='man_green.png' width='23 height='47' alt='yellow face'></td><td>"

    res3_en = "% chance of no kidney cancer upstaging,</td>   
    </tr><tr>
    <td class='center'><img src='man_green.png' width='23 height='47' alt='green face'></td><td>"
    ...
    res4_en = "% chance of no kidney cancer upstaging.</td>"
    ...
    htmlString_en = if (risk[2] == 0) {
        paste(res0_en,res1_en,"<1",res2_en,">99",res4_en,res5_en,end, sep="")
    } else if  (risk[2] == 100) {
        paste(res0_en,res1_en,">99",res2_en,"<1",res4_en,res5_en,end, sep="")
    } else {
        paste(res0_en,res1_en,risk[2],res2_en,risk[1],res4_en,res5_en,end, sep="")
    }
