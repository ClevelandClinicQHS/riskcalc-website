...
calcSmiley = function(risk){
    ...
    <table height=80% width=90%>
    <tbody><tr>
    <td ><img src='man_orange.png' width='35' height='35' alt='orange face'></td><td>"
    
    res2_en = "% chance that the biopsy is negative for cancer,</td>
    </tr><tr>
    ...
    <td class='center'><img src='man_red.png' width='35' height='35' alt='red face'></td><td>"
    ...
    res4_en = "% chance of high-grade prostate cancer.</td>"
    ...
    htmlString_en = paste(res0_en,res1_en,risk[1],res2_en,risk[2],res3_en,risk[3],res4_en,res5_en,end, sep="")
...
stats_en = HTML("<h1>PBCG Risk Calculator Users</h1> <br> 
