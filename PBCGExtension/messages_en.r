...
tooltip_exoepi_en = "ExosomeDx score needs to be between 0 and 100."

tooltip_age_en = "Age needs to be between 40 and 90 years."

tooltip_psa_en = "This is the result, in nanograms per mililiter, of the PSA blood test. PSA has to be between 2 and 10 [ng/ml]."
