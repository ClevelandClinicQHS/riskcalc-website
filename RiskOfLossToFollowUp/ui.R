...
fluidPage(theme = shinytheme("flatly"),
  ...
  if (confirm("This is a mailbox for reporting website errors to programmers for the risk calculator website.  If you have questions or concerns about a specific calculator, please use the calculator Author Contact Information found on the publication for that calculator.  Each calculator is documented by a specific publication with a corresponding author.")) {
    window.open("mailto:rcalcsupport@ccf.org");
          ...
          titlePanel('Risk of Loss to Follow-Up (LTFU) After Surgery'),
          sidebarLayout(
            sidebarPanel(id = "sidebar",
                         ...
                         numericInput('Education', 'Education (years)', value = 12, min = 0, max = 25),
                         selectInput('Smoking', 'Smoking Status', choices = c('Never', 'Quit', 'Current')),
                         selectInput('Surgeon', 'Surgeon', choices = all_surgeons)
            ),
            mainPanel(
              ...
              br(),
              wellPanel(h3('About This Calculator'),
                        p("This calculator estimates the probability of loss to follow-up (LTFU) after surgery, based on a predictive model developed using patient and surgical characteristics.")),
              ...
              p(a("Homepage",
                ...
                " | ",
                a("Source Code",
                  href = "https://github.com/ClevelandClinicQHS/riskcalc-website/tree/main/RiskOfLossToFollowUp",
