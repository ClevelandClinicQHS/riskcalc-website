...
risk = function(psa, pct_freePSA, age, race, priorbiopsy, dre, famhistory, 
  ...
  #### update 11.03.2014 with pct_freePSA -----
  ...
  #if family history or SNPs are not given continue without update
  else{
