...
calcSmiley = function(risk){
    ...
    htmlString = paste(htmlString, "<tr>", "<td colspan=3><h4>Age + PSA (", risk[1]/10, "%N, ", risk[2]/10, "%L, ", risk[3]/10, "%H)", 
                       "</h4></td><td colspan=3><h4>Age + PSA + Prompt (", risk[4]/10, "%N, ", risk[5]/10, "%L, ", risk[6]/10, "%H)",
                       "</h4></td>", sep="")
    ...
    htmlString = paste(htmlString, "<tr>", "<td colspan=3><h4>Age + PSA (Toronto) (",risk[7]/10, "%N, ", risk[8]/10, "%L, ", risk[9]/10, "%H)",
                       "</h4></td><td colspan=3><h4>Age + PSA + Prompt (Toronto) (", risk[10]/10, "%N, ", risk[11]/10, "%L, ", risk[12]/10, "%H)",
                       "</h4></td>", sep="")
